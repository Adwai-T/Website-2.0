...
;hljs.registerLanguage("markdown",e)})();/*! `makefile` grammar compiled for Highlight.js 11.5.1 */
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `css` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict"
...
contains:[{begin:/\\./}]}]}}})();hljs.registerLanguage("r",e)})();/*! `c` grammar compiled for Highlight.js 11.5.1 */
...
end:"$",illegal:"\n"},o]}}})();hljs.registerLanguage("kotlin",e)})();/*! `csharp` grammar compiled for Highlight.js 11.5.1 */
